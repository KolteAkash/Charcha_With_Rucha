...
import cwr.com.CharchaWithRucha.model.Top_video;
...
@Repository
public interface TopVideoRepository extends JpaRepository<Top_video,Integer> {
    @Query("SELECT tv.top_video_id, tv.priority, " +
            "v.video_id, v.video_url, vt.description as video_title, vd.description as video_description, vsd.description as video_short_description, v.video_img, " +
            ...
            "FROM Top_video tv " +
            "JOIN Video v ON tv.video.video_id = v.video_id " +
            ...
            "WHERE tv.priority > 0 " +
            "ORDER BY tv.priority ASC")
    List<Object[]> getTopVideosWithLocalizedData(String languageId);
}
